...
function AddCube() {
    ...
    cube.position.x = dataJSON.vipsaloti[0].posx;
    cube.position.y = dataJSON.vipsaloti[0].posy;
    cube.position.z = dataJSON.vipsaloti[0].posz;
    cube.scale.x -= dataJSON.vipsaloti[0].scalex;
    cube.scale.y -= dataJSON.vipsaloti[0].scaley;
    cube.scale.z -= dataJSON.vipsaloti[0].scalez;
...
var mesh = new THREE.Mesh(new THREE.SphereGeometry(2, 50, 50), sphereMaterial);
...
loader.load(highresimg, (texture) => {
    //hide spin
